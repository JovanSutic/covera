    ...
    <div className={cn("relative w-full", containerClassName)}>
      ...
      >
        <textarea
          ...
          className={cn(
            "peer w-full px-3 pt-6 pb-2 text-base text-black bg-transparent border-0 outline-none focus:ring-0 placeholder-transparent resize-y min-h-[80px]",
            className
          )}
          {...props}
        />
